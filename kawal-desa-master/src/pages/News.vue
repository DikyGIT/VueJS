          ...
          <div class="col-xl-8 stretch-card grid-margin">
            <div class="position-relative">
              <div v-if="post.length != 0">
                ...
                />
                <img
                  v-else-if="post.feature_image === undefined"
                  src="https://via.placeholder.com/724x435"
                  alt=""
                />
                ...
                <div class="banner-content">
                  ...
                  <h1 class="mb-0">
                    <router-link
                      v-bind:to="`/news-detail/${slugVillage}/${post.slug}`"
                    ...
                    <div class="row" v-for="post in posts" v-bind:key="post.id">
                      <div class="col-sm-4 grid-margin">
                        <div class="position-relative">
                          <div class="rotate-img">
                            ...
                            <img
                              v-else
                              src="https://via.placeholder.com/322x196"
                              alt=""
                            />
                          </div>
                        </div>
                      ...
                      <div class="col-sm-8  grid-margin">
                        <h2 class="mb-2 font-weight-600">
                          <router-link
                            v-bind:to="
                              `/news-detail/${slugVillage}/${post.slug}`
                            "
...
export default {
  ...
  filters: {
    getDate: function(date) {
      const formattedDate = format(new Date(date), "dd LLLL yyyy", {
        locale: id
      });
  ...
  methods: {
    getNews: async function() {
      try {
        ...
        this.posts = await ghost.posts.browse({
          filter: `primary_author:${this.slugVillage}`,
